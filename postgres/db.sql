...
CREATE SEQUENCE transaction_payment_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;
...
ALTER TABLE ONLY "public"."eth_transaction" ADD CONSTRAINT "eth_transaction_block_number_fkey" FOREIGN KEY (block_number) REFERENCES block(number) NOT DEFERRABLE;

ALTER TABLE ONLY "public"."transaction_payment" ADD CONSTRAINT "transaction_payment_transaction_id_fkey" FOREIGN KEY (transaction_id) REFERENCES eth_transaction(id) NOT DEFERRABLE;

-- 2022-11-12 04:22:29.270872+00